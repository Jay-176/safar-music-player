...
export default function Yaadein() {
  ...
  useEffect(() => {
    const files = import.meta.glob('/src/audio/yaadein/*.{mp3,MP3,wav,WAV,m4a,M4A}', { 
    ...
    const dynamicTracks = Object.entries(files).map(([filePath, fileUrl], index) => {
      ...
      return { id: `yaadein-${index}`, title: fileName.trim(), src: fileUrl };
    });
    ...
    <PageShell>
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden z-0">
        <video autoPlay loop muted playsInline className="w-full h-full object-cover scale-[1.30]">
          <source src="/videos/yaadein.mp4" type="video/mp4" />
        </video>
